...
\section{考察}
本実験により，走行中に取得した環境センサデータを自己位置推定の結果と同期させ，
圃場内の空間分布として可視化できることを確認した．
特に分光データについては，288次元のスペクトルを正規化した上で，
植生に関連する特徴量や類似度として抽出することで，
生育環境の空間的な違いをマップ上に反映できることが示された．
